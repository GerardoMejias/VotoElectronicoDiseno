...
public class ResultadosListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultados_list);
        ...
        listViewPropuesta = (ListView) findViewById(R.id.listView26);

        //Método que carga las Propuestas desde la base de datos
        capturarPropuestas();

        Button atras = (Button) findViewById(R.id.button41);
